...
> 2026-09: илова бар кормандон — **мизоҷони худсабтшуда** (SaaS): сабти ном (`Customer`,
> JWT scheme-и алоҳида), обуна (фазаи 13) ва автоматизатсияи Instagram-и **худашон** (фазаи 14).
> Кормандон бетағйиранд. Ду системаи корбар ҳеҷ гоҳ омехта намешаванд.
...
- Multi-tenancy-и пурра (ширкатҳои бисёр бо кормандони худ) — кормандон як ширкатанд.
  Мизоҷон танҳо каналҳо ва автоматизатсияи худро доранд (`Channel.CustomerId`), ҷудо бо
  global query filter — ниг. `docs/phases/phase-14-customer-automations.md`
...
11. **Ҳар endpoint ошкоро месанҷад, ки кист:** `RequirePermission(...)` (корманд) ё
    `CustomerOnly` (мизоҷ, + тариф агар функсия пулакӣ бошад). Endpoint "бе санҷиш" нест;
    анонимӣ танҳо webhook/OAuth callback/auth-и ҷамъиятӣ бо ҳимояи худ (имзо, state, rate limit).
    Барои ҳар endpoint-и нав тести "актёри нодуруст" (→ 401/403/404).
