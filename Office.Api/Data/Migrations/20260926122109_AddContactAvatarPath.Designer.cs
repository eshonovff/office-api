...
namespace Office.Api.Data.Migrations
{
    ...
    [Migration("20260926122109_AddContactAvatarPath")]
    partial class AddContactAvatarPath
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.AutomationRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ConditionConfigJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("condition_config_json");
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.AutomationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ActorExternalId")
                        ...
                        .HasColumnName("actor_external_id");

                    b.Property<string>("CommentReplyStatus")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("comment_reply_status");
                    ...
                    b.Property<string>("FollowCheckResult")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("follow_check_result");
                    ...
                    b.Property<string>("TargetMediaExternalId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("target_media_external_id");

                    b.Property<string>("TriggerExternalId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("trigger_external_id");

                    b.HasKey("Id");

                    b.HasIndex("RuleId", "CreatedAt");

                    b.HasIndex("RuleId", "ActorExternalId", "TargetMediaExternalId", "CreatedAt");
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.Broadcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("MediaPreviewDataUri")
                        .HasColumnType("text")
                        .HasColumnName("media_preview_data_uri");
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.BroadcastRecipient", b =>
                {
                    ...
                    b.HasKey("BroadcastId", "ContactId");

                    b.HasIndex("ContactId", "SentAt");

                    b.ToTable("broadcast_recipients");
                });
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.ContactTag", b =>
                {
                    b.Property<Guid>("ContactId")
                        .HasColumnType("uuid")
                        .HasColumnName("contact_id");
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.ContactVariable", b =>
                {
                    b.Property<Guid>("ContactId")
                        .HasColumnType("uuid")
                        .HasColumnName("contact_id");
                    ...
                    b.HasKey("ContactId", "Key");

                    b.ToTable("contact_variables");
                });

            modelBuilder.Entity("Office.Api.Data.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ContactAvatarPath")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                        .HasColumnName("contact_avatar_path");

                    b.Property<string>("ContactAvatarUrl")
                        .HasColumnType("text")
                        .HasColumnName("contact_avatar_url");
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.CustomerExternalLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.FlowConversion", b =>
                {
                    b.Property<Guid>("FlowId")
                        .HasColumnType("uuid")
                        .HasColumnName("flow_id");
                    ...
                    b.HasKey("FlowId", "ContactId");

                    b.HasIndex("ContactId");

                    b.HasIndex("FlowId", "CreatedAt");

                    b.ToTable("flow_conversions", (string)null);
                });

            modelBuilder.Entity("Office.Api.Data.Entities.FlowEdge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("FlowId", "FromNodeId");

                    b.ToTable("flow_edges");
                });

            modelBuilder.Entity("Office.Api.Data.Entities.FlowNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("flow_nodes");
                });

            modelBuilder.Entity("Office.Api.Data.Entities.FlowSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("FlowId", "TriggerExternalId");

                    b.HasIndex("FlowId", "ContactId", "Status");

                    b.ToTable("flow_sessions");
                });

            modelBuilder.Entity("Office.Api.Data.Entities.FlowSessionStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("flow_session_steps");
                });

            modelBuilder.Entity("Office.Api.Data.Entities.FlowTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("flow_templates");
                });

            modelBuilder.Entity("Office.Api.Data.Entities.InstagramComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AutoReplyError")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("auto_reply_error");
                    ...
                    b.Property<bool>("PostedByAutomation")
                        .HasColumnType("boolean")
                        .HasColumnName("posted_by_automation");

                    b.Property<DateTimeOffset?>("PrivateReplySentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("private_reply_sent_at");
                    ...
                    b.HasIndex("ChannelId", "CommentedAt");

                    b.HasIndex("ChannelId", "ExternalId")
                        .IsUnique();

                    b.HasIndex("ChannelId", "IsRead");

                    b.HasIndex("ChannelId", "MediaExternalId", "CommentedAt");

                    b.ToTable("instagram_comments");
                });
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CreatedAt", "Direction");

                    b.ToTable("messages");
                });

            modelBuilder.Entity("Office.Api.Data.Entities.MessageTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.User", b =>
                {
                    ...
                    b.Property<string>("ContractDocumentFileName")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                    ...
                    b.Property<string>("ContractDocumentPath")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("contract_document_path");
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.WebhookLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.AutomationRun", b =>
                {
                    b.HasOne("Office.Api.Data.Entities.AutomationRule", "Rule")
                        .WithMany("Runs")
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.Broadcast", b =>
                {
                    ...
                    b.HasOne("Office.Api.Data.Entities.Flow", "Flow")
                        .WithMany()
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.BroadcastRecipient", b =>
                {
                    b.HasOne("Office.Api.Data.Entities.Broadcast", "Broadcast")
                        .WithMany("Recipients")
                        .HasForeignKey("BroadcastId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Office.Api.Data.Entities.Conversation", "Contact")
                        .WithMany()
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.FlowSessionStep", b =>
                {
                    b.HasOne("Office.Api.Data.Entities.FlowSession", "Session")
                        .WithMany()
            ...
            modelBuilder.Entity("Office.Api.Data.Entities.Message", b =>
                {
                    ...
                    b.HasOne("Office.Api.Data.Entities.User", "SentByUser")
                        .WithMany()
