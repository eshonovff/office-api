...
> ⚠️ Танҳо қисматҳои марбут ба endpoint-ҳои иҷрошуда тасдиқ шудаанд
> (бо `curl` дар муҳити локалӣ, ниг. `docs/PROGRESS.md`). Ду банди
> вобаста ба 6.12-6.14 (доступ) ва 6.7 (notes) ҳанӯз тасдиқ НАШУДА.
...
- ✅ Ҷавоб бо шаблон кор мекунад (`SendTemplateAsync` васл шуд; санҷиши воқеӣ бо Meta ҳанӯз мемонад, монанди фазаи 5)
