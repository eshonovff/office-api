...
### Доступ ⚠️
- [x] 6.12 Филтри канал: танҳо каналҳое ки узви `channel_members` аст (Owner/Admin — ҳама)
- [x] 6.13 Филтри `only_assigned`: танҳо чатҳои `assigned_to = me`
- [x] 6.14 Ҳарду филтр дар **ҳамаи** query-ҳои боло — `IChannelAccessGuard` (`Office.Api/Common/ChannelAccessGuard.cs`), як ҷо, на такрор
...
> воқеӣ санҷида шуд — корбар тасдиқ кард. Филтри доступ (6.12-6.14)
> дар ҳамин рӯз илова ва бо `curl` санҷида шуд. Танҳо 6.7 (notes)
> ҳанӯз боқӣ мондааст.

- ✅ Operator танҳо каналҳои худро мебинад (`ChannelAccessGuard`, санҷидашуда: узви канал не → 404/холӣ)
- ✅ Operator бо `only_assigned` танҳо чатҳои худро мебинад (санҷидашуда: узв аммо таъиннашуда → 404/холӣ; таъиншуда → намоён)
